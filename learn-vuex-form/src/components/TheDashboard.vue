            ...
            <div class="row mt-3">
              <div class="col-6 pr-1">
                <img
                  ...
                  alt="image"
                />
                <img :src="img4" class="mw-100 w-100 rounded" alt="image" />
              </div>
              <div class="col-6 pl-1">
                <img
                  ...
                  alt="image"
                />
                <img :src="img3" class="mw-100 w-100 rounded" alt="image" />
              </div>
            </div>
...
import img1 from "../assets/images/dashboard/img_1.jpg";
import img2 from "../assets/images/dashboard/img_2.jpg";
import img3 from "../assets/images/dashboard/img_3.jpg";
